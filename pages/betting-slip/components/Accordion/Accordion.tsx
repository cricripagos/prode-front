    ...
    return (
        <div>
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} style={{ background: '#333647', color: 'white' }}>
                ...
                <AccordionDetails>
                    {props.data.matches?.map((dataMatch, i) => <Matches setSlip={props.setSlip} slip={props.slip} setExpanded={setExpanded}  data={dataMatch} setChecked={setChecked} indexesSlip={props.data.indexesSlip} />)}  
                </AccordionDetails>
            </Accordion>
